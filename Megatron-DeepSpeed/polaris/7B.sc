...
export DATA_FILE_LIST="$FILESYSTEM/datasets/dolma/dolma_v1_7_file_list_v2.txt"
...
runcmd="mpiexec --pmi=pmix -np $((PBS_JOBSIZE*PPN)) --ppn $PPN --cpu-bind depth -d 16 python3 ${MD}/pretrain_gpt_alcf.py \
      ...
      --log-optimizer-states-to-tensorboard  --lr 0.003 --optimizer ${OPT} --eval-iters 10  --distributed-backend nccl \
